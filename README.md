...
The most important file is `particle_filter.cpp` in the `src` directory. The file contains the scaffolding of a `ParticleFilter` class and some associated methods. Read through the code, the comments, and the header file `particle_filter.h` to get a sense for what this code is expected to do.
...
## Success Criteria
There is a grading code in this project to evaluate your code performance. If it passes your code, you code is working well! ^^
...
https://github.com/georgesung/particle_filter
...
`Amani, Sajjad. "Kidnapped Vehicle: Implementing a 2D particle filter to localize a vehicle." GitHub, 5 December 2019, https://github.com/Sj-Amani/Kidnapped-Vehicle`
